...
/// <summary>
/// Decoded O3 (ワイドオッズ) record.
/// JV-Data 4.9.0.1 §JV_O3_ODDS_WIDE, 2654 bytes.
/// </summary>
public sealed record O3
{
    ...
    public required string WideFlag { get; init; }

    /// <summary>ワイド — Kumi (4) / OddsLow (5) / OddsHigh (5) / Ninki (3), 153 entries.</summary>
    public required string[] Kumi { get; init; }
    public required string[] OddsLow { get; init; }
    public required string[] OddsHigh { get; init; }
    public required string[] Ninki { get; init; }

    public required string TotalHyosuWide { get; init; }
}
