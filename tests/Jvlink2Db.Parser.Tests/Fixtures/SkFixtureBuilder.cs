...
internal sealed class SkFixtureBuilder
{
    public const int RecordLength = 208;

    private readonly byte[] _buffer;

    public SkFixtureBuilder()
    {
    ...
    public SkFixtureBuilder With(int oneBasedOffset, int length, string value)
    {
    ...
    public SkFixtureBuilder RecordSpec(string value) => With(1, 2, value);
    public SkFixtureBuilder KettoNum(string value) => With(12, 10, value);
    public SkFixtureBuilder BirthDate(string yyyymmdd) => With(22, 8, yyyymmdd);
    public SkFixtureBuilder Hansyoku(int index, string value) => With(67 + (index * 10), 10, value);
